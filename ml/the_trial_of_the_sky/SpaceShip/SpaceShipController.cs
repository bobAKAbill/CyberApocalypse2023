...
public class SpaceShipController : MonoBehaviour
{
    ...
    void Start(){
        ...
        spaceshipCheckPoint.checkpointArray = spaceshipCheckPoint.track.checkpointArray;
        playerStopped = false;
        playerHitWall = false;
        hitCheckPoint = false;
    ...
    void FixedUpdate(){
        ...
        if (spaceship.velocity.magnitude + 10 < .05f){
        ...
        if (Input.GetKey(KeyCode.W) || spaceshipDrive >0){
